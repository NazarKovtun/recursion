...
from src.factorial.FactorialWhileTail import FactorialWhileTail


class TestFactorialWhileTail(TestCase):
    """
    Test for the object Factorial that using the while tail loop
    """
    def setUp(self):
        self.sut = FactorialWhileTail()
