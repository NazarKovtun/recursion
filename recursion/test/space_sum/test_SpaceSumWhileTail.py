...
from src.space_sum.SpaceSumWhileTail import SpaceSumWhileTail


class TestSpaceSumWhileTail(TestCase):
    """
    Test for the object SpaceSum that using the while tail loop
    """
    def setUp(self):
        self.sut = SpaceSumWhileTail()
