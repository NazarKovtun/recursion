...
from src.sum.SumWhileTail import SumWhileTail


class TestSumWhileTail(TestCase):
    """
    Test for the object Sum that using the while tail loop
    """
    def setUp(self):
        self.sut = SumWhileTail()
